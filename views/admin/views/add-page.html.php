...
<div class="wmd-panel">
	<form method="POST">
		...
		<br>
		<textarea name="description" rows="3" cols="20"><?php if (isset($p->description)) {echo $p->description->value;} ?></textarea>
		<br><br>
		...
		<?php if ($type == 'is_page') :  // FIXME ($type)
            ?>
		<input type="submit" name="submit" class="submit" value="Publish"/>
		<?php endif;?>
		<?php if (($type == 'is_category') || ($type == 'is_tag')) :?>
