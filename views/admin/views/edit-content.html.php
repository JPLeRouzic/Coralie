...
<div class="wmd-panel">
    <form method="POST">
        ...
        <br>
        <input type="text" name="title" class="text <?php if (isset($postTitle)) {
    if (empty($postTitle)) {
        echo 'error';
    }
        ...
        <input type="text" name="tag" class="text <?php if (isset($postTag)) {
    if (empty($postTag)) {
        echo 'error';
    }
        ...
        <textarea name="description" rows="3" cols="20"><?php if (isset($p->description)) {
...
<?php if ($type == 'is_science_ed'): ?>
            ...
            <br>
            <textarea rows="3" cols="20" class="text <?php if (isset($postImage)) {
        if (empty($postImage)) {
            echo 'error';
        }
