...
// namespace Michelf;
require_once dirname(__FILE__) . '/MarkdownInterface.inc.php';
...
//				}
	...
	protected function _detab_callback($matches) {
		$line = $matches[0];
		$strlen = $this->strlen; // strlen function for UTF-8.
	...
	/**
	 * Check for the availability of the function in the `strlen` property
	...
	protected function _initDetab() {
		...
		if (function_exists($this->strlen)) {
			return;
		}

		$this->strlen = fn($text) => preg_match_all('/[\x00-\xBF]|[\xC0-\xFF][\x80-\xBF]*/', $text, $m);
	}
